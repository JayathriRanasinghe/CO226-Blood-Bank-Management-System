<?php 
    ...
    // Writing a mysql query to retrieve data  email='$donor_username' AND password='$donor_password'"
    $sql = "SELECT * FROM donor_account WHERE donor_id = 1";
        ...
        <body>
            ...
            <div class="display">
                ...
                <div class="subTextDisplay">
                    ...
                    <p>[Time]</p>
                    <p>[blood bank]</p>
                    <p> Name : <?php echo $row["email"] . " " . $row["password"]; ?> </p> 
                </div>
            ...
            <div class="card">
                ...
                <h1>[Donor Name Here]</h1>
                <p class="">[District Here]</p>
                <p>No of donations here</p>
